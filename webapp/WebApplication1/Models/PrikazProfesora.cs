...
{
    public class PrikazProfesora
    {
        public int Profesor_Id { get; internal set; }
        public string zvanje { get; internal set; }
        ...
        public string stalan_zaposlenik { get; internal set; }
